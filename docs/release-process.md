...
release-preparation pull request intentionally promotes a verified candidate.
...
3. Fetch and fast-forward the Arrakis Control Panel repository `main`.
4. Confirm the repository remote is
