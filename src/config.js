...
const DEFAULT_PATHS = Object.freeze({
  ...
  "guild-faction-summary": "/api/integrations/discord/guilds/faction-summary",
  ...
  const config = {
    ...
    adapter: {
      ...
      paths: {
        ...
        "guild-faction-summary": optionalEnv(env, "DUNE_ADAPTER_GUILD_FACTION_SUMMARY_PATH") || DEFAULT_PATHS["guild-faction-summary"],
      ...
      methods: {
        ...
        "guild-faction-summary": parseMethod(env.DUNE_ADAPTER_GUILD_FACTION_SUMMARY_METHOD, DEFAULT_METHODS["guild-faction-summary"]),
