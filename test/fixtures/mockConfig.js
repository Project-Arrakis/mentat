    ...
    discord: {
      ...
      rbac: {
        ...
        commandRoleIds: {
          ...
          'player:link': ['observer-role-id', 'admin-role-id'],
          'player:verify': ['observer-role-id', 'admin-role-id'],
          'player:characters': ['observer-role-id', 'admin-role-id'],
          'player:enable': ['observer-role-id', 'admin-role-id'],
          'player:disable': ['observer-role-id', 'admin-role-id'],
          'player:default': ['observer-role-id', 'admin-role-id'],
          'player:unlink': ['observer-role-id', 'admin-role-id'],
          'player:faction': ['observer-role-id', 'admin-role-id'],
          'player:whoami': ['observer-role-id', 'admin-role-id'],
          'player:inventory': ['observer-role-id', 'admin-role-id'],
          'player:find': ['observer-role-id', 'admin-role-id'],
          'player:storage': ['observer-role-id', 'admin-role-id'],
          ...
          'ops:armory': ['observer-role-id', 'admin-role-id'],
